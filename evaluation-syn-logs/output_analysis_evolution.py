...
def main():
    ...
    for file_name in file_name_list:
        ...
        df = df[df['len_trace'] >= int(agent_starting_at)]  # IMPORTANT, CONSIDER REWARD ONLY FOR TRACES LONGER THAN THE ACTIVATION POINT OF THE POLICY
        ...
        value_dict = {
            ...
            'agent_starting_at': agent_starting_at,
