...
- mdp-policy-learning: contains the code to train policies with clusterisation, mdp creation and dynamic programming
- deep-rl-cql: contains the code to train policies with offline deep RL, CQL algorithm
